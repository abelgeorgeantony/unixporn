...
apt_apps+=("testmfmfmfjfsfdasfdabelgeorgeantony" "brightnessctl" "build-essential" "nodejs" "npm" "meson" "ninja-build" "cmake" "gettext" "zip" "unzip" "dconf-editor" "snapd" "flatpak" "mpv" "audacious" "gimp" "tmux" "neovim" "vim" "conky-all" "taskwarrior" "gnome-multi-writer")
