...
apt_deps+=("build-essential" "uniutils" "clang" "xwayland" "wayland-protocols" "pkg-config" "libdbusmenu-glib-dev" "libdbusmenu-gtk3-dev" "libgtk-layer-shell-dev" "libgtk-3-dev" "adb" "libusb-1.0-0-dev" "v4l-utils" "libv4l-dev" "libwayland-dev" "libegl-dev" "libmpv-dev" "python3-i3ipc" "libgtk-4-media-gstreamer" "unifont" "fonts-material-design-icons-iconfont" "fonts-font-awesome")
