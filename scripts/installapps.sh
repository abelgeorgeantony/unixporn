...
apt_apps+=("testmfmfmfjfsfdasfdabelgeorgeantony" "build-essential" "fuckyouuoou" "nodejs" "npm" "meson" "ninja-build" "gettext" "zip" "unzip" "dconf-editor" "snapd" "flatpak" "mpv" "gimp" "tmux" "neovim" "vim" "conky-all" "taskwarrior" "gnome-multi-writer")
